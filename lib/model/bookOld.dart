...
final countryValues = EnumValues({"TR": Country.TR});
...
final textToSpeechPermissionValues = EnumValues({"ALLOWED": TextToSpeechPermission.ALLOWED, "ALLOWED_FOR_ACCESSIBILITY": TextToSpeechPermission.ALLOWED_FOR_ACCESSIBILITY});
...
final languageValues = EnumValues({"en": Language.EN, "tr": Language.TR});
